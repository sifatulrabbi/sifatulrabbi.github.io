...
import { IProjectCard, IProjectCardFeatured } from "../../src/interfaces";
...
export const projectsData: IProjectCard[] = [
  {
    ...
    icons: [SiTypescript, SiNodedotjs, SiMongodb, SiPassport, SiJsonwebtokens],
  },
  {
    ...
    icons: [SiTypescript, SiNextdotjs, SiTailwindcss, SiNodedotjs, SiExpress],
  },
  {
